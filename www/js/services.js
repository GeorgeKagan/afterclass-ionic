angular.module('afterclass.services', [])
    ...
    .factory('PaypalService', ['$q', '$ionicPlatform', '$filter', '$timeout', function ($q, $ionicPlatform, $filter, $timeout) {
        ...
        function createPayment(total, name) {
            var payment = new PayPalPayment("" + total, "USD", "" + name);
            return payment;
        }
        /**
         * @ngdoc method
        ...
        function configuration() {
            ...
            var config = new PayPalConfiguration({merchantName: 'AfterClass', merchantPrivacyPolicyURL: 'afterclass.com', merchantUserAgreementURL: 'afterclass.com'});
            return config;
        }
